...
//!
//! \brief The InferenceParams structure groups the basic parameters required by
//!        all sample networks.
//!
...
//!
//! \brief The CaffeInferenceParams structure groups the additional parameters required by
//!         networks that use caffe
//!
struct CaffeInferenceParams : public InferenceParams
{
...
//!
//! \brief The OnnxInferenceParams structure groups the additional parameters required by
//!         networks that use ONNX
//!
struct OnnxInferenceParams : public InferenceParams
{
    std::string onnxFileName; //!< Filename of ONNX file of a network
};

//!
//! \brief The UffInferenceParams structure groups the additional parameters required by
//!         networks that use Uff
//!
struct UffInferenceParams : public InferenceParams
{
